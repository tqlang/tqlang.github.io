...
In tq, any error, exception or invalid operation is handled as a Fault. \
...
To make sure that the fault will not be a problem to the process, the compiler will not
